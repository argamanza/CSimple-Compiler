...
MULTI_PROC : MULTI_PROC PROC { $$ = makeNode("Multi Procedures", $1, $2); }
           | PROC { $$ = $1; }
           ;
...
PROC_CALL : ID LP MULT_EXP RP { $$ = makeNode("Procedure Call",$1, $3); }
          | ID LP RP { $$ = makeNode("Procedure Call No Params",$1, NULL); }
          ;
